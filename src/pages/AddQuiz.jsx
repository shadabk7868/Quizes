...
export default function AddQuiz() {
    ...
    const [category, setCategory] = useState(""); // Input field
    const [question, setQuestion] = useState("");
    const [options, setOptions] = useState({ a: "", b: "", c: "", d: "" });
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        if (!category || !question) return alert("Category and Question required");
        ...
        setFormData({
            ...
            [category]: [
                ...oldArr,
                { question, options: { ...options }, correctOption },
            ],
        });
        ...
        <div className="container mt-5">
            ...
            >
                ...
                <div className="d-flex gap-2 justify-content-between">
                    <button className="btn btn-primary flex-grow-1">Add Question</button>
                    <button
                        type="button"
